export const MultisigAbi = [
  ...
  { inputs: [], name: "DelayAlreadyStarted", type: "error" },
  ...
  { inputs: [{ internalType: "address", name: "account", type: "address" }], name: "NotInMemberList", type: "error" },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint16", name: "emergencyMinApprovals", type: "uint16" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "bytes", name: "secondaryMetadata", type: "bytes" },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_proposalId", type: "uint256" },
      { internalType: "bytes", name: "_secondaryMetadata", type: "bytes" },
    ],
