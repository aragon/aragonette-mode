...
export const PUB_API_BASE_URL = process.env.NEXT_API_BASE_URL ?? "http://localhost:3000/api";
export const PUB_BASE_URL = process.env.NEXT_BASE_URL ?? "http://localhost:3000/";
